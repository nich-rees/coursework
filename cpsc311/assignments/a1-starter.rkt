...
;; Some extra tests just for fun, basically rendering our blended images
;; (I initially interpreted the question wrong and accidentally made unnecessary tests)
(test (render (blend RT0)) (square 20 "solid" "red"))
(test (render (blend RT2)) (above (square 20 "solid" "red")
                           (above (square 20 "solid" "blue")
                                   (square 20 "solid" "red"))))
(test (render (blend RT4))
      (beside
       (above (square 20 "solid" "red")
               (above (square 20 "solid" "blue") (square 20 "solid" "red")))
       (beside (above (square 20 "solid" "blue")
               (above (square 20 "solid" "red") (square 20 "solid" "blue")))
              (above (square 20 "solid" "red")
               (above (square 20 "solid" "blue") (square 20 "solid" "red"))))))
(test (render (blend RT5)) empty-image)
(test (render (blend RT6)) empty-image)
(test (render (blend/lort (list))) empty-image)
(test (render (blend/lort (list RT0))) (square 20 "solid" "red"))
(test (render (blend/lort (list RT1 RT0)))
      (beside (square 20 "solid" "blue") (square 20 "solid" "red")))
(test (render (blend/lort (list RT4 RT0 RT2)))
      (beside
       (beside
       (above (square 20 "solid" "red")
               (above (square 20 "solid" "blue") (square 20 "solid" "red")))
