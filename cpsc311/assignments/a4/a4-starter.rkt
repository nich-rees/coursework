...
;!!! just put in all the examples and data definitions
...
; !!! still need to show variables (pass-by-reference!) and booleans
;; BY-REFERENCE SEMANTICS:
       ...
       {with {g {f 9}}
             {with {d {g 2}}
                   {with {c {g 3}}
                         {seqn {setobj c 7}
                               d}}}}}
; basically, a in binding context, both of them point to a's location
